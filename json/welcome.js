...
$.ajax({  
    ...
    let pos = ipLocation.result.ad\_info.nation;  
    let ip;  
    let posdesc;  
    //根据国家、省份、城市信息自定义欢迎语  
    switch (ipLocation.result.ad\_info.nation) {  
    case "日本":  
    ...
    break;  
    case "中国":  
    pos = ipLocation.result.ad\_info.province + " " + ipLocation.result.ad\_info.city + " " + ipLocation.result.ad\_info.district;  
    ip = ipLocation.result.ip;  
    switch (ipLocation.result.ad\_info.province) {  
    case "北京市":  
    posdesc = "北——京——欢迎你~~~";  
    break;  
    case "天津市":  
    ...
    break;  
    case "江苏省":  
    switch (ipLocation.result.ad\_info.city) {  
    case "南京市":  
    posdesc = "这是我挺想去的城市啦";  
    break;  
    case "苏州市":  
